...
void UMyGameInstance::Shutdown()
{
	...
	CheckUObjectIsNull(PropStudent, TEXT("NonPropStudent"));
	CheckUObjectIsValid(PropStudent, TEXT("NonPropStudent"));

	CheckUObjectIsNull(NonPropStudents[0], TEXT("NonPropStudents"));
	CheckUObjectIsValid(NonPropStudents[0], TEXT("NonPropStudents"));

	CheckUObjectIsNull(PropStudents[0], TEXT("NonPropStudents"));
	CheckUObjectIsValid(PropStudents[0], TEXT("NonPropStudents"));
}
